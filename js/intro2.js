...
(function () {
  ...
  var FRAG_SKY = [
    ...
    '  vec3 col = vec3(0.006, 0.008, 0.025) + vec3(0.05, 0.04, 0.12)*neb*0.4;',
  ...
  var PLANETS = [
    { ph: 0.0,  R: 0.80, size: 0.17, speed: 1.55, type: 3, ring: 0, tilt: 0.1, cA: [0.62,0.62,0.62], cB: [0.35,0.35,0.38] },
    { ph: 0.7,  R: 1.02, size: 0.23, speed: 1.20, type: 3, ring: 0, tilt: 0.1, cA: [0.92,0.82,0.55], cB: [0.65,0.5,0.3] },
    { ph: 1.4,  R: 1.26, size: 0.25, speed: 1.00, type: 1, ring: 0, tilt: 0.4, cA: [0.16,0.45,0.8],  cB: [0.14,0.55,0.2] },
    { ph: 2.1,  R: 1.50, size: 0.20, speed: 0.82, type: 3, ring: 0, tilt: 0.2, cA: [0.85,0.45,0.25], cB: [0.5,0.2,0.12] },
    { ph: 2.8,  R: 1.92, size: 0.46, speed: 0.55, type: 0, ring: 0, tilt: 0.1, cA: [0.85,0.65,0.42], cB: [0.5,0.32,0.18] },
    { ph: 3.5,  R: 2.22, size: 0.40, speed: 0.40, type: 0, ring: 1, tilt: 0.35,cA: [0.92,0.78,0.5],  cB: [0.6,0.42,0.22] },
    { ph: 4.2,  R: 2.50, size: 0.28, speed: 0.28, type: 2, ring: 0, tilt: 0.7, cA: [0.5,0.75,0.85], cB: [0.25,0.5,0.6] },
    { ph: 4.9,  R: 2.72, size: 0.28, speed: 0.20, type: 3, ring: 0, tilt: 0.3, cA: [0.2,0.4,0.9],   cB: [0.08,0.2,0.5] }
  ];
  var ORBIT_COLORS = [
  ...
  function play(canvas, overlay, onDone) {
    ...
    function frame() {
      ...
      /* 相机：俯视太阳系盘面，环绕太阳缓转，更贴近更有冲击 */
      var camAng = t * 0.07;
      var dist = 3.9 - Math.sin(t * 0.5) * 0.15;
      var eye = [Math.sin(camAng) * dist, 1.9, Math.cos(camAng) * dist];
      var proj = mat4Perspective(58 * Math.PI / 180, w / h, 0.1, 30);
      ...
      gl.uniformMatrix4fv(gl.getUniformLocation(sunProg, 'uModel'), false, trs(0, 0, 0, 0, 0, 0.52));
    ...
    overlay.addEventListener('touchstart', function (e) { e.preventDefault(); stop(); }, { passive: false });
